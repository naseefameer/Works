                ...
                <div class="card-body">
                  ...
                  >
                    <div class="btn-group">
                      <button
                        type="button"
                        class="btn btn-sm btn-outline-secondary btns1"
                      >
                        View
                      </button>
                    </div>
...
export default {
  ...
  methods: {
    ...
    removeProductCart(product) {
      const products = JSON.parse(localStorage.getItem("nas-cart"));
      ...
      localStorage.setItem("nas-cart", JSON.stringify(products));
